...
@Component({
  selector: 'app-giveCreateOnlyAccess',
  templateUrl: './revokeCreateOnlyAccess.component.html',
  styleUrls: ['./revokeCreateOnlyAccess.component.scss']
})
export class RevokeCreateOnlyAccessComponent {
...
// tslint:disable-next-line: no-shadowed-variable
  ...
  submit() {
    ...
    this.contract.revokeCreateOnlyAccessToDoctor(this.direction, this.address).then((r) => {
      this.contract.succes();
// tslint:disable-next-line: no-shadowed-variable
    }).catch((e) => {
      this.contract.failure('Transaction failed');
