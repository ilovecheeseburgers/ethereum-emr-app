...
@Component({
  ...
  templateUrl: './giveCreateOnlyAccess.component.html',
  styleUrls: ['./giveCreateOnlyAccess.component.scss']
})
export class GiveCreateOnlyAccessComponent  {
...
// tslint:disable-next-line: no-shadowed-variable
  ...
  submit(){
    ...
    this.contract.giveCreateOnlyAccessToDoctor(this.direction, this.address).then((r) => {
      this.contract.succes();
// tslint:disable-next-line: no-shadowed-variable
    }).catch((e) => {
      this.contract.failure('Transaction failed');
